...
namespace App\Http\Controllers\PRO\Strategy_tests\Grant;
...
class GrantController extends Controller
{
    ...
    /*... MANAGE ...*/
    public function page_grant_manage()
    {
        ...
        return view('PRO.Strategy_tests.Grant.page_grant_manage',[
    ...
    /*... UPDATE ...*/
    public function page_grant_update(Request $request)
    {
        ...
        $check_selected_value = DB::table('model_grant')
            ->where('firm_name', $selected_firm)
            ->get();
        ...
        if(!empty($check_selected_value[0]))
        {
            ...
            /*... Передаем в вид ...*/
            return redirect()->route('page-grant-manage')->with('success','Updated');
        }
        else
        {
            // --- Создаем
            ...
            /*... Передаем в вид ...*/
            return redirect()->route('page-grant-manage')->with('success','Created');
        }
    }
