...
class ManageController extends Controller
{
    ...
    /*... MANAGE ...*/
    public function page_ife_manage($category)
    {
        ...
        return view('PRO.Ie_matrix.Ife.page_ife_manage',[
    ...
    public function page_ife_store(Request $request, $category)
    {
        /*... Часть 1 ...*/
        ...
        /*... Передаем в вид ...*/
        return redirect()->route('page-ife-manage', $category)->with('success','Элемент добвален');
    }

    public function page_ife_destroy($category, $id)
    {
        // Удаляем элемент
        DB::table('model_ife')->where('id', $id)->delete();

        /* Перенаправляем на главную страницу с сообщением */
        return redirect()->route('page-ife-manage', [$category])->with('success','Элемент удален');
    }
    /*...*/
