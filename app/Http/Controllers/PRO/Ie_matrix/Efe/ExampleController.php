...
class ExampleController extends Controller
{
    ...
    /*... EXAMPLE ...*/
    public function page_efe_example($category)
    {
        ...
        if($category == 3)
        {
            ...
            $table_intro = "Saistās ar kultūras attieksmēm, ētiskiem uzskatiem, kopīgām vērtībām, dzīves stila deferenciācijas līmeni, demogrāfiju, izglītības līmeņiem utt. Sociālo faktoru novērošana palīdz organizācijām saglabāt to reputāciju iesaistīto pušu acīs.";
        }
        if($category == 4)
        {
        ...
        return view('PRO.Ie_matrix.Efe.page_efe_example',[
