        ...
        <table width="850px" class="table-bordered">
            <tr align="center">
                <td rowspan="2" width="170">
                    ...
                    <a href="/my_page/firm_canvas_edit/kp" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
                <td height="170px" width="170">
                    <img src="/images/Canvas/kd.png" ><br>
                    {{ $model_canvas_kd_result }}<br>
                    Galvenās aktivitātes<br>
                    <a href="/my_page/firm_canvas_edit/kd" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
                <td colspan="2" rowspan="2" width="85">
                    <img src="/images/Canvas/cp.png" ><br>
                    {{ $model_canvas_cp_result }}<br>
                    Vērtigie piedavājumi<br>
                    <a href="/my_page/firm_canvas_edit/cp" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
                <td height="170px" width="170">
                    <img src="/images/Canvas/vk.png" ><br>
                    {{ $model_canvas_vk_result }}<br>
                    Attiecības ar klientiem<br>
                    <a href="/my_page/firm_canvas_edit/vk" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
                <td rowspan="2" width="170">
                    <img src="/images/Canvas/ps.png" ><br>
                    {{ $model_canvas_ps_result }}<br>
                    Pateretāju segmenti<br>
                    <a href="/my_page/firm_canvas_edit/ps" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
            </tr>
            <tr align="center">
                <td height="170px">
                    ...
                    Galvenie resursi<br>
                    <a href="/my_page/firm_canvas_edit/kr" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
                <td height="170px">
                    <img src="/images/Canvas/ks.png" ><br>
                    {{ $model_canvas_ks_result }}<br>
                    Noietas kanali<br>
                    <a href="/my_page/firm_canvas_edit/ks" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
            </tr>
            <tr height="150px" align="center">
                <td colspan="3">
                    ...
                    <a href="/my_page/firm_canvas_edit/si" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
                <td colspan="3">
                    <img src="/images/Canvas/pd.png" ><br>
                    {{ $model_canvas_pd_result }}<br>
                    Ienākumu struktūra<br>
                    <a href="/my_page/firm_canvas_edit/pd" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </td>
            </tr>
        </table>
    </div>
