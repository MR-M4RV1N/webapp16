            ...
            @foreach($item as $item)
                <tr height="30px">
                    ...
                    <td width="40px" align="center">
                        <a href="/my_page/firm_canvas_crud_edit/{{  $canvas_block }}/{{ $item->id }}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                    </td>
                    <td width="40px" align="left">
                        {!! Form::open(['method' => 'DELETE','route' => ['firm_canvas_crud_destroy', $canvas_block, $item->id]]) !!}
