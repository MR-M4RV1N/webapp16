...
@section('content')
            ...
            @foreach($item as $item)
                <tr height="30px">
                    ...
                    <td width="40px" align="center">
                        <a href="/my_page/page_success_edit/{{ $category }}/{{ $item->id }}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                    </td>
                    <td width="40px" align="left">
                        {!! Form::open(['method' => 'DELETE','route' => ['page-success-destroy', $category, $item->id]]) !!}
    ...
    <div align="center" style="margin-top:30px;">
        {!! Form::open(array('route' => ['page-success-store', $category],'method'=>'POST')) !!}
