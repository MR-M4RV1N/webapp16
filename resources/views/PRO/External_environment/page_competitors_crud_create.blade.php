...
@section('content')
    ...
    <div align="center">
        <h3>Konkurenta pievienošana</h3>
    </div>

    <br><br>
    <hr>

    {!! Form::open(array('route' => ['page-competitors-crud-store'],'method'=>'POST')) !!}
    <table width="800px" align="center">
        <tr>
            ...
            <td width="70%">
                {!! Form::text('competitor_name', null, array('placeholder' => 'Введите текст', 'class' => 'form-control')) !!}
            </td>
        </tr>
    </table>
