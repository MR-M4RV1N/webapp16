...
@section('content')
                            ...
                            @foreach ($svid_content as $content)
                                <tr>
                                    ...
                                    <td width="10px" align="center">
                                        <a href="/my_page/svid_areja_edit/{{ $category }}/{{ $content->id }}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                    </td>
                                    <td width="10px" align="center">
                                        {!! Form::open(['method' => 'DELETE','route' => ['svid-areja-destroy', $category, $content->id]]) !!}
    ...
    <div align="center" style="margin-top:30px;">
        {!! Form::open(array('route' => ['svid-areja-store', $category],'method'=>'POST')) !!}
