...
@section('content')
    ...
    <div align="center">
        {!! Form::open(array('route' => ['svid-iekseja-update', $category, $svid_item_id],'method'=>'POST')) !!}
        <div class="form-group" align="left" style="width:700px;">
            ...
            <input type="text" name="item" value="{{ $svid_item_item }}" class="form-control" style="border-radius: 0rem;">
        </div>
