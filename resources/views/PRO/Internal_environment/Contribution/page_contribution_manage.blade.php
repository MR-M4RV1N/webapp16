...
@section('content')
            ...
            @foreach($item as $item)
                <tr height="30px">
                    ...
                    <td width="40px" align="center">
                        <a href="/my_page/page_contribution_edit/{{ $item->id }}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                    </td>
                    <td width="40px" align="left">
                        {!! Form::open(['method' => 'DELETE','route' => ['page-contribution-destroy', $category, $item->id]]) !!}
    ...
    <div align="center" style="margin-top:30px;">
        {!! Form::open(array('route' => ['page-contribution-store', $category],'method'=>'POST')) !!}
