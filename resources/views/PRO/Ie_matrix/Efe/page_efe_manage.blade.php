...
@section('content')
    ...
    <div align="center">
        ...
        {!! Form::open(array('route' => ['page-efe-update-1', $category],'method'=>'POST')) !!}
        <table class="table-bordered" width="850px">
            ...
            @else
                <tr height="40px">
                    <td colspan="4" align="center">EFE table is empty. Get data from SWOT</td>
                </tr>
                <tr height="40px">
                    <td colspan="4" align="center"><a href="/my_page/page_efe_copy_from_swot/1" type="button" class="btn btn-primary btn-sm">Copy from SWOT</a> </td>
                </tr>
            @endif
            ...
            @else
                ...
                <tr height="40px">
                    <td colspan="4" align="center"><a href="/my_page/page_efe_copy_from_swot/2" type="button" class="btn btn-primary btn-sm">Copy from SWOT</a> </td>
                </tr>
            @endif
