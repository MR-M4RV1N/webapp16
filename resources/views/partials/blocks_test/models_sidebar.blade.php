<div id="sidebar-wrapper" style="">
    ...
    <div style="color: #AAA7A0; height: 70px; text-align: center; cursor:pointer;" onclick="location.href='/page_canvas'" onmouseover="this.style.fontSize='130%';" onmouseout="this.style.fontSize='100%';">
        <span class=" glyphicon glyphicon-stop" aria-hidden="true" style="padding-top:20px;"><p style="font-size: x-small; margin-top:3px;">CANVAS</p></span>
    </div>
    <div style="color: #AAA7A0; height: 70px; text-align: center; cursor:pointer;" onclick="location.href='/page_main'" onmouseover="this.style.fontSize='130%';" onmouseout="this.style.fontSize='100%';">
    ...
    <div style="background-color: #4A4542; color: white; height: 70px; text-align: center; cursor:pointer;"  onclick="location.href='/page_models'" onmouseover="this.style.fontSize='130%';" onmouseout="this.style.fontSize='100%';">
