<div id="sidebar-wrapper" style="">
    ...
    <div style="color: #AAA7A0; height: 70px; text-align: center; cursor:pointer;" onclick="location.href='/page_settings'" onmouseover="this.style.fontSize='130%';" onmouseout="this.style.fontSize='100%';">
    ...
    <div style="background-color: #4A4542; color: white; height: 70px;  text-align: center; cursor:pointer;" onclick="location.href='/page_database'" onmouseover="this.style.fontSize='130%';" onmouseout="this.style.fontSize='100%';">
