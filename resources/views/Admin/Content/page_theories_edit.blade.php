...
@section('content')
    ...
    <!-- Content -->
    {!! Form::open(array('route' => ['page-theories-update', $item->id],'method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
    <div align="left" style="margin-left:30px;"> <!-- div для выравнивания по центру -->
        ...
        <div style="margin-top:50px;">
            <strong>Текст:</strong>
            {!! Form::textarea('text', $item->description, array('placeholder' => 'Введите текст','class' => 'myeditablediv')) !!}
        </div>
